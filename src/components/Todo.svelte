...
<li class="bg-white flex items-center shadow-sm border border-gray-200 rounded-lg my-2 py-2 px-4">
    ...
    <button type="button" class="text-sm bg-gray-500 hover:bg-gray-600 py-1 px-2 rounded focus:outline-none focus:shadow-outline text-white" on:click={() => deleteTodo(todo.id)}>Delete</button>
</li>